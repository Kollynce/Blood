    ...
    <div id="app">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="text-center brand-link">
                <!-- <img src="{{asset('images/user.webp')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"> -->
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('donor.index')}}" class="nav-link active">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2019 <a href="http://tina.test">Tina</a>.</strong> All rights
            reserved.
        </footer>
    </div>
</body>
